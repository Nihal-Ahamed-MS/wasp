...
import { StrictMode, lazy, startTransition, use, useEffect, useState } from "react";
...
//#endregion
//#region .wasp/out/sdk/wasp/dist/client/app/hooks/useIsClient.js
/**
...
function Layout({ children, isFallbackPage = false, clientEntrySrc }) {
	const shouldRenderChildren = useIsClient() || !isFallbackPage;
	return /* @__PURE__ */ jsx(StrictMode, { children: /* @__PURE__ */ jsxs("html", {
		...
		] }), /* @__PURE__ */ jsxs("body", { children: [/* @__PURE__ */ jsx("noscript", { children: "You need to enable JavaScript to run this app." }), /* @__PURE__ */ jsx("div", {
			id: "root",
...
//#endregion
//#region routes.tsx
var routesMapping = { RootRoute: { Component: lazy(() => __vitePreload(() => import("./MainPage.js").then((m) => m.MainPage), __vite__mapDeps([0,1])).then((component) => ({ default: component }))) } };
...
function App() {
	return /* @__PURE__ */ jsx(Layout, {
		isFallbackPage,
		children: /* @__PURE__ */ jsx(WaspApp, { children: /* @__PURE__ */ jsx(RouterProvider, { router }) })
	});
}
startTransition(() => {
